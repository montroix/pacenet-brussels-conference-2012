...
;
// $Id: faceted_ajax_search.js,v 1.1.2.3 2009/10/04 15:50:33 itarato Exp $
...
Drupal.behaviors.faceted_ajax_search = function(context) {
  $('.block-faceted_search_ui a', context).each(function(){
    $(this).click(function(){
      ...
      // If link doesn not contain the word: results, it means it points to the
...
;
 ...
 // window.setTimeout("ows_fadeOut()", 3000);
//

//function ows_fadeOut() {
//  var messages = $("#content-header div.messages");
//  if (messages.length) {
...
$(function () {
	var $alert = $('#block-privatemsg-privatemsg-new');
	if($alert.length)
	{
		var alerttimer = window.setTimeout(function () {
			$alert.trigger('click');
		}, 4000);
		$alert.animate({height: $alert.css('line-height') || '250px'}, 600)
		.click(function () {
 ...
 $('.active-trail ul.menu').show();
 $('.active-trail ul.menu').height();
